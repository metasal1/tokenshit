(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,74576,20119,56350,e=>{"use strict";var t=e.i(31507);let i={attribute:!0,type:String,converter:t.defaultConverter,reflect:!1,hasChanged:t.notEqual};function r(e){return(t,r)=>{let l;return"object"==typeof r?((e=i,t,r)=>{let{kind:l,metadata:a}=r,o=globalThis.litPropertyMetadata.get(a);if(void 0===o&&globalThis.litPropertyMetadata.set(a,o=new Map),"setter"===l&&((e=Object.create(e)).wrapped=!0),o.set(r.name,e),"accessor"===l){let{name:i}=r;return{set(r){let l=t.get.call(this);t.set.call(this,r),this.requestUpdate(i,l,e,!0,r)},init(t){return void 0!==t&&this.C(i,void 0,e,t),t}}}if("setter"===l){let{name:i}=r;return function(r){let l=this[i];t.call(this,r),this.requestUpdate(i,l,e,!0,r)}}throw Error("Unsupported decorator location: "+l)})(e,t,r):(l=t.hasOwnProperty(r),t.constructor.createProperty(r,e),l?Object.getOwnPropertyDescriptor(t,r):void 0)}}e.s(["property",0,r],20119),e.s(["state",0,function(e){return r({...e,state:!0,attribute:!1})}],56350),e.s([],74576)},45975,e=>{"use strict";e.s(["customElement",0,function(e){return function(t){return"function"==typeof t?(customElements.get(e)||customElements.define(e,t),t):function(e,t){let{kind:i,elements:r}=t;return{kind:i,elements:r,finisher(t){customElements.get(e)||customElements.define(e,t)}}}(e,t)}}])},12699,e=>{"use strict";e.s(["UiHelperUtil",0,{getSpacingStyles:(e,t)=>Array.isArray(e)?e[t]?`var(--apkt-spacing-${e[t]})`:void 0:"string"==typeof e?`var(--apkt-spacing-${e})`:void 0,getFormattedDate:e=>new Intl.DateTimeFormat("en-US",{month:"short",day:"numeric"}).format(e),formatCurrency(e=0,t={}){let i=Number(e);return isNaN(i)?"$0.00":new Intl.NumberFormat("en-US",{style:"currency",currency:"USD",minimumFractionDigits:2,maximumFractionDigits:2,...t}).format(i)},getHostName(e){try{return new URL(e).hostname}catch(e){return""}},getTruncateString:({string:e,charsStart:t,charsEnd:i,truncate:r})=>e.length<=t+i?e:"end"===r?`${e.substring(0,t)}...`:"start"===r?`...${e.substring(e.length-i)}`:`${e.substring(0,Math.floor(t))}...${e.substring(e.length-Math.floor(i))}`,generateAvatarColors(e){let t=e.toLowerCase().replace(/^0x/iu,"").replace(/[^a-f0-9]/gu,"").substring(0,6).padEnd(6,"0"),i=this.hexToRgb(t),r=getComputedStyle(document.documentElement).getPropertyValue("--w3m-border-radius-master"),l=100-3*Number(r?.replace("px","")),a=`${l}% ${l}% at 65% 40%`,o=[];for(let e=0;e<5;e+=1){let t=this.tintColor(i,.15*e);o.push(`rgb(${t[0]}, ${t[1]}, ${t[2]})`)}return`
    --local-color-1: ${o[0]};
    --local-color-2: ${o[1]};
    --local-color-3: ${o[2]};
    --local-color-4: ${o[3]};
   ...
   `},hexToRgb(e){let t=parseInt(e,16);return[t>>16&255,t>>8&255,255&t]},tintColor(e,t){let[i,r,l]=e;return[Math.round(i+(255-i)*t),Math.round(r+(255-r)*t),Math.round(l+(255-l)*t)]},isNumber:e=>/^[0-9]+$/u.test(e),getColorTheme:e=>e?e:"u">typeof window&&window.matchMedia&&"function"==typeof window.matchMedia?window.matchMedia("(prefers-color-scheme: dark)")?.matches?"dark":"light":"dark",splitBalance(e){let t=e.split(".");return 2===t.length?[t[0],t[1]]:["0","00"]},roundNumber:(e,t,i)=>e.toString().length>=t?Number(e).toFixed(i):e,cssDurationToNumber:e=>e.endsWith("s")?1e3*Number(e.replace("s","")):e.endsWith("ms")?Number(e.replace("ms","")):0,maskInput({value:e,decimals:t,integers:i}){if("."===(e=e.replace(",",".")))return"0.";let[r="",l]=e.split(".").map(e=>e.replace(/[^0-9]/gu,"")),a=i?r.substring(0,i):r,o=2===a.length?String(Number(a)):a,n="number"==typeof t?l?.substring(0,t):l;return("string"==typeof n&&("number"!=typeof t||t>0)?[o,n].join("."):o)??""},capitalize:e=>e?e.charAt(0).toUpperCase()+e.slice(1):""}])},62238,73944,e=>{"use strict";e.i(12207);var t=e.i(8285),i=e.i(54479);e.i(74576);var r=e.i(20119),l=e.i(59088),a=e.i(12699),o=e.i(45975),n=e.i(15193);let h=n.css`
  :host {
    display: flex;
    width: inherit;
    height: inherit;
...
`;var s=function(e,t,i,r){var l,a=arguments.length,o=a<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,r);else for(var n=e.length-1;n>=0;n--)(l=e[n])&&(o=(a<3?l(o):a>3?l(t,i,o):l(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o};let p=class extends t.LitElement{render(){return this.style.cssText=`
      ...
      width: ${this.width};
    `,i.html`<slot></slot>`}};p.styles=[l.resetStyles,h],s([(0,r.property)()],p.prototype,"flexDirection",void 0),s([(0,r.property)()],p.prototype,"flexWrap",void 0),s([(0,r.property)()],p.prototype,"flexBasis",void 0),s([(0,r.property)()],p.prototype,"flexGrow",void 0),s([(0,r.property)()],p.prototype,"flexShrink",void 0),s([(0,r.property)()],p.prototype,"alignItems",void 0),s([(0,r.property)()],p.prototype,"justifyContent",void 0),s([(0,r.property)()],p.prototype,"columnGap",void 0),s([(0,r.property)()],p.prototype,"rowGap",void 0),s([(0,r.property)()],p.prototype,"gap",void 0),s([(0,r.property)()],p.prototype,"padding",void 0),s([(0,r.property)()],p.prototype,"margin",void 0),s([(0,r.property)()],p.prototype,"width",void 0),p=s([(0,o.customElement)("wui-flex")],p),e.s([],73944),e.s([],62238)},91909,e=>{"use strict";e.s(["Directive",0,class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},"PartType",0,{ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},"directive",0,e=>(...t)=>({_$litDirective$:e,values:t})])},39009,93090,53976,e=>{"use strict";e.i(12207);var t=e.i(8285),i=e.i(54479);e.i(74576);var r=e.i(20119),l=e.i(91909);let a=(0,l.directive)(class extends l.Directive{constructor(e){if(super(e),e.type!==l.PartType.ATTRIBUTE||"class"!==e.name||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){if(void 0===this.st){for(let i in this.st=new Set,void 0!==e.strings&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(e=>""!==e))),t)t[i]&&!this.nt?.has(i)&&this.st.add(i);return this.render(t)}let r=e.element.classList;for(let e of this.st)e in t||(r.remove(e),this.st.delete(e));for(let e in t){let i=!!t[e];i===this.st.has(e)||this.nt?.has(e)||(i?(r.add(e),this.st.add(e)):(r.remove(e),this.st.delete(e)))}return i.noChange}});e.s(["classMap",0,a],93090),e.s([],53976);var o=e.i(62611),n=e.i(59088),h=e.i(45975);let s=o.css`
  slot {
    width: 100%;
...
`,c=r.svg`<svg viewBox="0 0 32 32" fill="none">
...
`,f=r.svg`<svg width="30" height="30" viewBox="0 0 30 30" fill="none">
...
`,Z=r.svg`<svg width="32" height="32" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
  <g clip-path="url(#a)">
...
`;e.s(["tonSvg",0,A],15571);let S=r.svg`
...
`,P=r.svg`<svg fill="none" viewBox="0 0 40 40">
  <g clip-path="url(#a)">
    <g clip-path="url(#b)">
...
</svg>`;var T=e.i(62611),O=e.i(59088),j=e.i(45975),D=e.i(15193);let R=D.css`
  :host {
    display: flex;
...
`;var F=function(e,t,i,r){var l,a=arguments.length,o=a<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,r);else for(var n=e.length-1;n>=0;n--)(l=e[n])&&(o=(a<3?l(o):a>3?l(t,i,o):l(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o};let G={add:"ph-plus",allWallets:"ph-dots-three",arrowBottom:"ph-arrow-down",arrowBottomCircle:"ph-arrow-circle-down",arrowClockWise:"ph-arrow-clockwise",arrowLeft:"ph-arrow-left",arrowRight:"ph-arrow-right",arrowTop:"ph-arrow-up",arrowTopRight:"ph-arrow-up-right",bank:"ph-bank",bin:"ph-trash",browser:"ph-browser",card:"ph-credit-card",checkmarkBold:"ph-check",chevronBottom:"ph-caret-down",chevronLeft:"ph-caret-left",chevronRight:"ph-caret-right",chevronTop:"ph-caret-up",clock:"ph-clock",close:"ph-x",coinPlaceholder:"ph-circle-half",compass:"ph-compass",copy:"ph-copy",desktop:"ph-desktop",dollar:"ph-currency-dollar",download:"ph-vault",exclamationCircle:"ph-warning-circle",extension:"ph-puzzle-piece",externalLink:"ph-arrow-square-out",filters:"ph-funnel-simple",helpCircle:"ph-question",id:"ph-identification-card",image:"ph-image",info:"ph-info",lightbulb:"ph-lightbulb",mail:"ph-envelope",mobile:"ph-device-mobile",more:"ph-dots-three",networkPlaceholder:"ph-globe",nftPlaceholder:"ph-image",plus:"ph-plus",power:"ph-power",qrCode:"ph-qr-code",questionMark:"ph-question",refresh:"ph-arrow-clockwise",recycleHorizontal:"ph-arrows-clockwise",search:"ph-magnifying-glass",sealCheck:"ph-seal-check",send:"ph-paper-plane-right",signOut:"ph-sign-out",spinner:"ph-spinner",swapHorizontal:"ph-arrows-left-right",swapVertical:"ph-arrows-down-up",threeDots:"ph-dots-three",user:"ph-user",verify:"ph-seal-check",verifyFilled:"ph-seal-check",wallet:"ph-wallet",warning:"ph-warning",warningCircle:"ph-warning-circle",appStore:"",apple:"",bitcoin:"",coins:"",chromeStore:"",cursor:"",discord:"",ethereum:"",etherscan:"",facebook:"",farcaster:"",github:"",google:"",playStore:"",paperPlaneTitle:"",reown:"",solana:"",ton:"",tron:"",telegram:"",twitch:"",twitterIcon:"",twitter:"",walletConnect:"",walletConnectBrown:"",walletConnectLightBrown:"",x:"",infoSeal:"",checkmark:""},I={"ph-arrow-circle-down":()=>e.A(82012),"ph-arrow-clockwise":()=>e.A(40171),"ph-arrow-down":()=>e.A(10729),"ph-arrow-left":()=>e.A(80342),"ph-arrow-right":()=>e.A(95724),"ph-arrow-square-out":()=>e.A(52792),"ph-arrows-down-up":()=>e.A(96302),"ph-arrows-left-right":()=>e.A(44243),"ph-arrow-up":()=>e.A(59668),"ph-arrow-up-right":()=>e.A(41373),"ph-arrows-clockwise":()=>e.A(69595),"ph-bank":()=>e.A(33052),"ph-browser":()=>e.A(280),"ph-caret-down":()=>e.A(92833),"ph-caret-left":()=>e.A(17096),"ph-caret-right":()=>e.A(5963),"ph-caret-up":()=>e.A(48774),"ph-check":()=>e.A(50090),"ph-circle-half":()=>e.A(38711),"ph-clock":()=>e.A(50621),"ph-compass":()=>e.A(5462),"ph-copy":()=>e.A(70963),"ph-credit-card":()=>e.A(56906),"ph-currency-dollar":()=>e.A(78023),"ph-desktop":()=>e.A(69039),"ph-device-mobile":()=>e.A(63605),"ph-dots-three":()=>e.A(42324),"ph-vault":()=>e.A(84968),"ph-envelope":()=>e.A(44020),"ph-funnel-simple":()=>e.A(50711),"ph-globe":()=>e.A(56601),"ph-identification-card":()=>e.A(81254),"ph-image":()=>e.A(79893),"ph-info":()=>e.A(1514),"ph-lightbulb":()=>e.A(44980),"ph-magnifying-glass":()=>e.A(84074),"ph-paper-plane-right":()=>e.A(67422),"ph-plus":()=>e.A(13200),"ph-power":()=>e.A(48479),"ph-puzzle-piece":()=>e.A(67369),"ph-qr-code":()=>e.A(77793),"ph-question":()=>e.A(4447),"ph-question-circle":()=>e.A(93690),"ph-seal-check":()=>e.A(77385),"ph-sign-out":()=>e.A(65739),"ph-spinner":()=>e.A(80304),"ph-trash":()=>e.A(9957),"ph-user":()=>e.A(22236),"ph-wallet":()=>e.A(40934),"ph-warning":()=>e.A(71802),"ph-warning-circle":()=>e.A(57792),"ph-x":()=>e.A(7885)},N={appStore:s,apple:p,bitcoin:g,coins:d,chromeStore:f,cursor:u,discord:m,ethereum:C,etherscan:v,facebook:w,farcaster:y,github:$,google:x,playStore:k,paperPlaneTitle:H,reown:M,solana:b,ton:A,tron:S,telegram:Z,twitch:P,twitter:E,twitterIcon:V,walletConnect:B,walletConnectInvert:z,walletConnectBrown:U,walletConnectLightBrown:_,x:E,infoSeal:L,checkmark:c},q={"accent-primary":T.vars.tokens.core.iconAccentPrimary,"accent-certified":T.vars.tokens.core.iconAccentCertified,"foreground-secondary":T.vars.tokens.theme.foregroundSecondary,default:T.vars.tokens.theme.iconDefault,success:T.vars.tokens.core.iconSuccess,error:T.vars.tokens.core.iconError,warning:T.vars.tokens.core.iconWarning,inverse:T.vars.tokens.theme.iconInverse},W=class extends t.LitElement{constructor(){super(...arguments),this.size="md",this.name="copy",this.weight="bold",this.color="inherit"}render(){this.style.cssText=`
    ...
    `;let e=G[this.name];if(e&&""!==e){let t=I[e];t&&t();let i={_$litStatic$:e,r:l};return h`<${i} size=${({xxs:"0.5em",xs:"0.75em",sm:"0.75em",md:"1em",mdl:"1.25em",lg:"1.25em",xl:"1.5em",xxl:"1.75em"})[this.size]} weight="${this.weight}"></${i}>`}return N[this.name]||h``}};W.styles=[O.resetStyles,R],F([(0,i.property)()],W.prototype,"size",void 0),F([(0,i.property)()],W.prototype,"name",void 0),F([(0,i.property)()],W.prototype,"weight",void 0),F([(0,i.property)()],W.prototype,"color",void 0),W=F([(0,j.customElement)("wui-icon")],W),e.s([],52634)}]);