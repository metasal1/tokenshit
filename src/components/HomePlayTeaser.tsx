...
export default function HomePlayTeaser() {
  ...
  return (
    <section className="rounded-2xl border border-neon/40 bg-gradient-to-b from-neon/10 via-card to-card overflow-hidden h-full flex flex-col">
      <div className="p-4 sm:p-5 md:p-5 lg:p-6 space-y-4 md:space-y-4 lg:space-y-5 flex flex-col flex-1">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0 text-left">
            ...
            <p className="mt-2 text-sm text-zinc-400 max-w-sm md:max-w-[16rem] lg:max-w-sm">
          ...
          <div className="text-right shrink-0">
            ...
            <div className="text-xl sm:text-2xl md:text-2xl lg:text-3xl font-mono font-bold text-neon tabular-nums">
              {cd}
            </div>
          </div>
        </div>

        <div className="grid grid-cols-2 gap-2 sm:gap-3 md:gap-2.5 lg:gap-3 flex-1 content-start">
          <div className="rounded-xl border border-green-500/25 bg-green-950/25 px-3 py-2.5 sm:py-3 md:py-2.5 lg:py-3 text-left">
            ...
            <div className="text-xl sm:text-2xl md:text-xl lg:text-2xl font-mono font-bold text-green-400 tabular-nums mt-0.5">
              {fmt(hit)}
            </div>
          ...
          <div className="rounded-xl border border-red-500/25 bg-red-950/25 px-3 py-2.5 sm:py-3 md:py-2.5 lg:py-3 text-right">
            ...
            <div className="text-xl sm:text-2xl md:text-xl lg:text-2xl font-mono font-bold text-red-400 tabular-nums mt-0.5">
              {fmt(shit)}
            </div>
            <div className="text-[10px] text-zinc-600 font-mono">
        ...
        <Link
          ...
          className="mt-auto flex w-full min-h-12 sm:min-h-14 md:min-h-12 lg:min-h-14 items-center justify-center rounded-xl bg-neon text-black text-base font-bold font-orbitron tracking-wide uppercase hover:brightness-110 active:scale-[0.99] transition shadow-[0_0_28px_rgba(57,255,20,0.2)]"
        >
          Play now
        </Link>
      </div>
