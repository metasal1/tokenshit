    ...
    <div className="flex flex-col items-center md:items-end gap-1.5">
      <div className="flex flex-wrap justify-center md:justify-end gap-2">
        ...
        <a
          ...
          className="inline-flex items-center gap-1.5 rounded-xl bg-zinc-100 px-3 py-2 text-[11px] font-bold text-black hover:bg-white active:scale-[0.98]"
        >
          <XLogo size={13} className="text-black" />
          Post
        </a>
        <a
          href={tgUrl}
