...
export const BRAND = {
  ...
  logo: {
    ...
    assets: {
      ...
      pumpfastPoster: "/brand/pumpfast-poster.png",
  ...
  voice: {
    ...
    dont: [
      ...
      "Posters always published on /posters + brand assets — never desk-only",
      "Posters always include token logos and/or brand emoji icons (never blank text-only)",
